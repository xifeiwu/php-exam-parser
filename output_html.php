    ...
    <div class=index-form>
		<form method="post" action="parser-exam.php">
            <div class="index-type">
    			...
    			<select id="exam-type"
    				...
    				<option value="objective-exam">单选、多选、判断</option>
		...
		<div id=notice-content>
			...
			<div class=element>
				...
				以数字、第[0-9]+题的形式开头<br> 正则表达式：'^(?: *[0-9]+.*?\.| *第[0-9]+题[:.]| *第[0-9]+题.?).+'<br>
			</div>
			<div class=element>
				<div class=title>2.关于选项</div>
				以字符A-F或[0-9])开头<br> 正则表达式：'^(?: *[A-F][\.:]| *[0-9]\)|[A-F][^A-F\.:]).+'<br>
			</div>
			<div class=element>
				<div class=title>3.关于答案</div>
				正则表达式：'^ *(?:[0-9]+\.)*\[*(?:参考答案|正确答案|标准答案|您的答案|正确答案|答案|本题正确答案为|答案及解析|答案)\]*(:.+?|[^:].+?)'<br>
			</div>
			<div class=element>
